...
# Probabilità per ROC-AUC (classe positiva = Churn=1)
y_proba = model.predict_proba(X_test)[:, 1]

# 6. Valuta le performance
print("\n[6/8] Valutazione delle performance...")

# Metriche richieste: Accuracy + Precision/Recall/F1 (classe Churn) + ROC-AUC
...
# 8. Salva il modello e le colonne
...
print(f"  - F1-score (Churn):  {f1_churn:.3f}")
print(f"  - ROC-AUC:           {roc_auc:.3f}")
print("  - Modello salvato: churn_model.pkl")
print("  - Colonne salvate: model_columns.pkl")
print("  - Pronto per la demo all'esame!")
